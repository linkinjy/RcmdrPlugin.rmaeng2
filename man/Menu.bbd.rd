...
\seealso{ See Also \code{\link[DoE.wrapper]{bbd.design}} for the function behind this menu and 
  also function \code{\link[rsm]{bbd}} from package 
  \pkg{rsm} for the function that underlies function \code{bbd.design}. 
  \code{\link{Menu.Quantitative}} describes the designs for quantitative factors 
  that are available in this software.}
